...
South Carolina’s governor submitted OZ 2.0 nominations, announced September 23, 2026. The source list is the [SC Commerce Final Recommendations PDF dated September 22, 2026](https://s3.amazonaws.com/cdn.sccommerce.com/scdoc-public/2026-09/Final%20Recommendations%20-%202026%209.22.26.pdf) (112 GEOIDs), committed at `data/oz/sc-oz2-nominated-official-sccommerce-2026-09-23.csv`. Only those GEOIDs read **Governor-nominated / awaiting Treasury**. Every other eligible tract stays **Eligible — not designated**. Nothing on the map is a certified 2027 QOZ, and nomination alone is not a tax benefit. Eligible ≠ nominated ≠ certified. Charleston, Charlotte’s South Carolina fringe (York, Lancaster, and Chester), Columbia, Greenville, and Savannah’s South Carolina fringe (Beaufort and Jasper) show that ladder when the GEOID is on screen. SC MF priority stays a separate internal hunt, not an eligibility label.
