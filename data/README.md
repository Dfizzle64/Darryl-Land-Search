...
| `data/oz2-other-msas-eligible.csv` | Eligible tracts for 16 smaller MSAs, including SWFL (1,461 rows, 1,416 GEOIDs; 502 rural / 959 urban) |
...
| `data/oz2-other-msas-counties.md` | County rings for the 16 smaller MSAs |
...
| `data/fixtures/oz2-eligible-packs.geojson` | One TIGER 2020 polygon per GEOID in the urban pack or the other-MSA pack (2,347) |
| `data/swfl-municipalities.json` | SWFL cities and villages, with the public GIS source or the documented gap |
