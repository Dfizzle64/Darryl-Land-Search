...
| `data/oz2-other-msas-eligible.csv` | Eligible tracts for 16 smaller MSAs (1,443 rows, 1,398 GEOIDs; 515 rural / 928 urban) |
...
| `data/fixtures/oz2-eligible-packs.geojson` | One TIGER 2020 polygon per GEOID in the urban pack or the other-MSA pack (2,342) |
