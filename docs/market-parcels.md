...
Zoning is joined when the county layer already carries a zoning field (DeKalb) or a public zoning polygon layer was wired (Stokes County Zoning). It is not a multifamily knowledge-base match outside Orange County. Prefer **All parcels** in these markets. Stokes future land use is Land Use 2035. OZ 2.0 eligibility is not a designated QOZ. See `docs/stokes-nc-parcels.md`.
...
| Winston-Salem | other | 91,802 | 9 | 0 | 0 |
