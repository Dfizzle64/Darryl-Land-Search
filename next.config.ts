...
const nextConfig: NextConfig = {
  ...
  outputFileTracingIncludes: {
    ...
    "/api/parcels": ["./data/fixtures/orlando-parcels/**/*", "./data/fixtures/screening/dekalb-batch40.json"],
    "/api/parcels/[id]": ["./data/fixtures/orlando-parcels/**/*", "./data/fixtures/screening/dekalb-batch40.json"],
    "/api/screening/point": [
