...
export default async function HomePage() {
  ...
  const catalog = {
    ...ruralCatalog,
    parcelNote:
      "Lake, Orange, Osceola, Polk, and Seminole load every public parcel from 5.0 through 150.0 acres. Other markets load their own 5–150 acre tiles only while that market is selected. Parcel outlines start at zoom 10 and draw every 5.0–150.0 acre parcel in view, with its real boundary, after the camera stops. Counties without an open polygon source stay documented gaps.",
  };
