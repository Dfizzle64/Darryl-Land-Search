...
import type { MunicipalParcelNote } from "./types";
...
export function formatJoinedZoning(
  ...
  municipal: Pick<MunicipalParcelNote, "placeName" | "unofficial" | "vintage"> | null | undefined,
): string | null {
...
export function brevardFluReason(
  ...
  municipal: Pick<MunicipalParcelNote, "fluGap" | "unofficial" | "vintage"> | null | undefined,
