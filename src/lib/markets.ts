...
const PARCEL_ONLY_MARKETS: Partial<Record<SearchMarketId, MarketSummary>> = {
  ...
  "North Florida": {
    ...
    center: [-82.2, 30.0],
    counties: [
      { county: "Columbia", state: "Florida", count: 0, outerEdge: false },
      { county: "Flagler", state: "Florida", count: 0, outerEdge: false },
      { county: "Hamilton", state: "Florida", count: 0, outerEdge: false },
      { county: "Lafayette", state: "Florida", count: 0, outerEdge: false },
      { county: "Suwannee", state: "Florida", count: 0, outerEdge: false },
      { county: "Union", state: "Florida", count: 0, outerEdge: false },
    ],
  },
  "Panhandle Florida": {
    market: "Panhandle Florida",
    rowCount: 0,
    ruralCount: 0,
    urbanCount: 0,
    bounds: [
    ...
    center: [-85.18, 30.3],
    counties: [
      { county: "Calhoun", state: "Florida", count: 0, outerEdge: false },
      { county: "Franklin", state: "Florida", count: 0, outerEdge: false },
      { county: "Gulf", state: "Florida", count: 0, outerEdge: false },
      { county: "Holmes", state: "Florida", count: 0, outerEdge: false },
      { county: "Jackson", state: "Florida", count: 0, outerEdge: false },
      { county: "Liberty", state: "Florida", count: 0, outerEdge: false },
      { county: "Washington", state: "Florida", count: 0, outerEdge: false },
    ],
  },
  Heartland: {
    market: "Heartland",
