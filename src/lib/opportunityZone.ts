...
export function describeOpportunityZone(info: OpportunityZoneInfo | null | undefined): {
  ...
  return {
    ...
    detail:
      "No — the parcel centroid is outside the current HUD/Treasury Qualified Opportunity Zone tracts (2010 census geography). OZ 2.0 nomination eligibility is a separate field and is not a designation.",
  };
}
...
export function describeOz2Eligibility(info: Oz2EligibilityInfo | null | undefined): {
  ...
  return {
    ...
    statusChip: null,
    detail:
      "This parcel centroid is outside the Rev. Proc. 2026-14 census tracts loaded for its county. It is not a 2027 QOZ designation, and it is not a statement about current designated Qualified Opportunity Zones.",
  };
}
