 ...
 * Florida markets stay together: SWFL on the gulf, then the east coast
 * south to north, then the panhandle. The rest of the order matches the research handoff.
 */
